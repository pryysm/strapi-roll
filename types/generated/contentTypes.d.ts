...
export interface ApiTestDataTestData extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<'api::test-data.test-data', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::test-data.test-data', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
